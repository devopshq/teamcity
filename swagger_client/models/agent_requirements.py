...
# from swagger_client.models.agent_requirement import AgentRequirement  # noqa: F401,E501


class AgentRequirements(object):
    ...
    def __init__(self, agent_requirement=None, count=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AgentRequirements, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AgentRequirements):
            return False
