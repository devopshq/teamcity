...
# from swagger_client.models.snapshot_dependency import SnapshotDependency  # noqa: F401,E501


class SnapshotDependencies(object):
    ...
    def __init__(self, count=None, snapshot_dependency=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SnapshotDependencies, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SnapshotDependencies):
            return False
