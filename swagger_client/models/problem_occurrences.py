...
# from swagger_client.models.problem_occurrence import ProblemOccurrence  # noqa: F401,E501


class ProblemOccurrences(object):
    ...
    def __init__(self, count=None, default=False, failed=None, href=None, ignored=None, muted=None, new_failed=None, next_href=None, passed=None, prev_href=None, problem_occurrence=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProblemOccurrences, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProblemOccurrences):
            return False
