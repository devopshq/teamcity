...
* v4 API:
  ...
  + :class:`teamcity.v4.objects.GroupMergeRequest`
  + :class:`teamcity.v4.objects.GroupMergeRequestManager`
  + :attr:`teamcity.v4.objects.Group.mergerequests`
  + :class:`teamcity.v4.objects.MergeRequest`
...
* v4 API:
  ...
  + :class:`teamcity.v4.objects.ProjectMergeRequest`
