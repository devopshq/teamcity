...
* v4 API:
  ...
  + :class:`teamcity.v4.objects.GroupSubgroup`
  + :class:`teamcity.v4.objects.GroupSubgroupManager`
  + :attr:`teamcity.v4.objects.Group.subgroups`
...
* v4 API:
  ...
  + :class:`teamcity.v4.objects.GroupCustomAttribute`
...
* v4 API:
  ...
  + :class:`teamcity.v4.objects.GroupMember`
...
Add a member to the group::
    ...
    member = group.members.create({'user_id': user_id,
                                   'access_level': teamcity.GUEST_ACCESS})

Update a member (change the access level)::

    member.access_level = teamcity.DEVELOPER_ACCESS
    member.save()
