...
* v4 API:
  ...
  + :attr:`teamcity.TeamCity.projects`

* TeamCity API: https://docs.teamcity.com/ce/api/projects.html
...
* TeamCity API: https://docs.teamcity.com/ce/api/project_import_export.html

Examples
--------

A project export is an asynchronous operation. To retrieve the archive
generated by TeamCity you need to:
...
* TeamCity API: https://docs.teamcity.com/ce/api/repository_files.html
...
* TeamCity API: https://docs.teamcity.com/ce/api/tags.html
...
* TeamCity API: https://docs.teamcity.com/ce/api/project_snippets.html
...
* TeamCity API: https://docs.teamcity.com/ce/api/members.html
...
* TeamCity API: https://docs.teamcity.com/ce/api/projects.html#hooks
...
* TeamCity API: https://docs.teamcity.com/ce/api/services.html
...
* TeamCity API: https://docs.teamcity.com/ce/api/projects.html#upload-a-file
...
* TeamCity API: https://docs.teamcity.com/ee/api/projects.html#push-rules
